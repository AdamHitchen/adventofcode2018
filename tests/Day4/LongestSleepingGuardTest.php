...
class LongestSleepingGuardTest extends \PHPUnit\Framework\TestCase
{
    /** @test */
    public function solution_matches_provided_examples()
    {
        ...
        $day4 = new LongestSleepingGuard($input);

        $this->assertEquals("4455", $day4->solve());
    ...
    public function solution_matches_solution()
    {
        ...
        $day4 = new LongestSleepingGuard($input);
        $this->assertEquals("4966",$day4->solve());
